...
def FFV2_3(F1, F2, COUP, M3, W3):
    ...
    TMP1 = F1[2] * (F2[4] * (P3[0] + P3[3]) + F2[5] * (P3[1] + 1j * (P3[2]))) + F1[
        3
    ] * (F2[4] * (P3[1] - 1j * (P3[2])) + F2[5] * (P3[0] - P3[3]))
    denom = COUP / (
        P3[0] ** 2 - P3[1] ** 2 - P3[2] ** 2 - P3[3] ** 2 - M3 * (M3 - 1j * W3)
    )
    ...
    V3[4] = (
        denom
        * (-1j)
        * (-1j * (F1[2] * F2[5]) + 1j * (F1[3] * F2[4]) - P3[2] * OM3 * TMP1)
    )
...
def FFV1P0_3(F1, F2, COUP, M3, W3):
    ...
    V3[2] = (
        denom * (-1j) * (F1[2] * F2[4] + F1[3] * F2[5] + F1[4] * F2[2] + F1[5] * F2[3])
    )
    V3[3] = (
        denom * (-1j) * (F1[4] * F2[3] + F1[5] * F2[2] - F1[2] * F2[5] - F1[3] * F2[4])
    )
    V3[4] = (
        denom
        * (-1j)
        * (-1j * (F1[2] * F2[5] + F1[5] * F2[2]) + 1j * (F1[3] * F2[4] + F1[4] * F2[3]))
    )
    V3[5] = (
        denom * (-1j) * (F1[3] * F2[5] + F1[4] * F2[2] - F1[2] * F2[4] - F1[5] * F2[3])
    )
    return V3


def FFV2_0(F1, F2, V3, COUP):
    TMP0 = F1[2] * (F2[4] * (V3[2] + V3[5]) + F2[5] * (V3[3] + 1j * (V3[4]))) + F1[
        3
    ] * (F2[4] * (V3[3] - 1j * (V3[4])) + F2[5] * (V3[2] - V3[5]))
    vertex = COUP * -1j * TMP0
    return vertex
...
def FFV1_0(F1, F2, V3, COUP):
    TMP2 = F1[2] * (F2[4] * (V3[2] + V3[5]) + F2[5] * (V3[3] + 1j * (V3[4]))) + (
        F1[3] * (F2[4] * (V3[3] - 1j * (V3[4])) + F2[5] * (V3[2] - V3[5]))
        + (
            F1[4] * (F2[2] * (V3[2] - V3[5]) - F2[3] * (V3[3] + 1j * (V3[4])))
            + F1[5] * (F2[2] * (+1j * (V3[4]) - V3[3]) + F2[3] * (V3[2] + V3[5]))
        )
    )
    vertex = COUP * -1j * TMP2
    return vertex
...
def FFV4_0(F1, F2, V3, COUP):
    ...
    TMP3 = F1[4] * (F2[2] * (V3[2] - V3[5]) - F2[3] * (V3[3] + 1j * (V3[4]))) + F1[
        5
    ] * (F2[2] * (+1j * (V3[4]) - V3[3]) + F2[3] * (V3[2] + V3[5]))
...
def FFV4_3(F1, F2, COUP, M3, W3):
    ...
    TMP4 = F1[4] * (F2[2] * (P3[0] - P3[3]) - F2[3] * (P3[1] + 1j * (P3[2]))) + F1[
        5
