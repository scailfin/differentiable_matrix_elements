...
class ModelParameters(object):
    ...
    def __init__(self, param_card=None):
        ...
        mdl_WT = slha.get_block_entry("decay", 6, 1.491500e00)
        mdl_WW = slha.get_block_entry("decay", 24, 2.047600e00)
        mdl_WZ = slha.get_block_entry("decay", 23, 2.441404e00)
        mdl_MTA = slha.get_block_entry("mass", 15, 1.777000e00)
        mdl_MH = slha.get_block_entry("mass", 25, 1.250000e02)
        mdl_MB = slha.get_block_entry("mass", 5, 4.700000e00)
        mdl_MT = slha.get_block_entry("mass", 6, 1.730000e02)
        mdl_MZ = slha.get_block_entry("mass", 23, 9.118800e01)
        mdl_ymtau = slha.get_block_entry("yukawa", 15, 1.777000e00)
        mdl_ymt = slha.get_block_entry("yukawa", 6, 1.730000e02)
        mdl_ymb = slha.get_block_entry("yukawa", 5, 4.700000e00)
        aS = slha.get_block_entry("sminputs", 3, 1.180000e-01)
        mdl_Gf = slha.get_block_entry("sminputs", 2, 1.166390e-05)
        aEWM1 = slha.get_block_entry("sminputs", 1, 1.325070e02)
        ...
        mdl_lam = mdl_MH__exp__2 / (2.0 * mdl_vev__exp__2)
        ...
        GC_51 = (mdl_cw * mdl_ee * mdl_complexi) / (2.0 * mdl_sw)
        GC_59 = (mdl_ee * mdl_complexi * mdl_sw) / (2.0 * mdl_cw)
    ...
    def __str__(self):
        ...
        res.append(
            "{:<20s} = {:<20.16e}".format("mdl_conjg__CKM3x3", self.mdl_conjg__CKM3x3)
        )
        res.append("{:<20s} = {:<20.16e}".format("mdl_CKM3x3", self.mdl_CKM3x3))
        res.append(
            "{:<20s} = {:<20.16e}".format("mdl_conjg__CKM1x1", self.mdl_conjg__CKM1x1)
        )
        ...
        res.append(
            "{:<20s} = {:<20.16e}".format("mdl_vev__exp__2", self.mdl_vev__exp__2)
        )
